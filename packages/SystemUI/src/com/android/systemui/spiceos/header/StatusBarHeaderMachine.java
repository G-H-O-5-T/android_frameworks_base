...
package com.android.systemui.spiceos.header;
...
public class StatusBarHeaderMachine {
    ...
    public static final String STATUS_BAR_HEADER_UPDATE_ACTION = "com.android.systemui.spiceos.header.STATUS_BAR_HEADER_UPDATE";
